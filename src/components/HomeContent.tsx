...
export default function HomeContent({ initialImages }: { initialImages: ImageResponse }) {
      ...
      <main className="max-w-5xl mx-auto py-8 px-4 md:py-12 space-y-12">
        ...
        <section className="space-y-6 max-w-2xl mx-auto">
          <div className="relative group">
            {initialImages && initialImages.cardnewsImages.length > 0 ? (
              <Swiper
                ...
                className="pb-14"
              >
                {initialImages.cardnewsImages.map((src, index) => (
